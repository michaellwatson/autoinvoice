...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="'+baseUrl+'/assets/js/extjs/ext-all.css"/>');
    }
    document.write('<script type="text/javascript" src="'+baseUrl+'/assets/js/extjs/ext-all.js"></script>');
    ...
    if (neptune) {
        ...
        neptunePath =baseUrl+'/assets/js/extjs/ext-theme-neptune.js';
